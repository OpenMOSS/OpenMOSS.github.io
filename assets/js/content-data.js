          ...
          blocks: [
            {
              ...
              paragraphs: {
                zh: [
                  ...
                  '（7）关于实习：我们只鼓励与研究方向和长期能力成长相关的“务正业”实习。团队与头部基础模型团队保持长期合作，会根据学生的研究表现和发展方向，择优推荐至合作团队实习。实习内容应与团队研究方向相关，帮助学生提升科研与工程能力。通常建议拥有 1–2 段实习经历，具体安排一事一议。由团队毕业生主导创办的公司也会提供实习机会，表现优秀者还有机会获得股权激励。对于部分研究项目，如果团队暂时无法保障充足的算力资源，我们也会主动推荐学生到外部合作团队实习。除最后一年外，我们不鼓励参加与研究方向无关、仅以短期求职为目的的实习。'
                ],
                en: [
