          ...
          blocks: [
            {
              ...
              paragraphs: {
                zh: [
                  ...
                  '（5）提前进组：研一课程较多、时间有限，因此希望确定来本组的同学提前进组学习；外校保研最好来复旦大学做毕业设计。我们在保证科研连续性和培养质量的前提下，支持学生在合适阶段参加与研究方向相关的实习（通常 1–2 年）。本课题组卡资源充足，也为同学提供参与真实项目、提升工程能力的锻炼机会。',
                  '（6）研究生待遇：参考同水平科研单位平均水平，在学校补贴之外提供较有竞争力的研究生补助；对专硕有一定的租房补贴，参与企业合作项目的学生还有额外科研补助，可对标大厂实习待遇。',
                  '（7）关于实习：我们只鼓励与研究方向和长期能力成长相关的“务正业”实习。课题组与头部基础模型团队保持长期合作，将根据学生的研究表现和发展方向，择优推荐到合作团队实习；实习内容应与团队研究方向相关，帮助学生提升科研与工程能力。通常建议实习 1–2 年，具体安排一事一议。由实验室毕业生主导创立的公司也提供实习机会，表现优秀者还有机会获得股权激励。对于部分研究项目，如果课题组暂时无法保障充足的算力资源，我们也会主动推荐学生到外部合作团队实习。除最后一年外，我们不鼓励与研究方向无关、仅以短期求职为目的的实习。'
                ],
                en: [
