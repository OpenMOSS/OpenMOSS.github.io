...
const teamData = {
    ...
    phdStudents: [
        ...
        { id: 'yanxin-chen', name: { zh: '陈衍鑫', en: 'Yanxin Chen' }, photo: 'assets/img/default-avatar.svg' },
        { id: 'jiajun-chen', name: { zh: '陈嘉骏', en: 'Jiajun Chen' }, photo: 'assets/img/default-avatar.svg' },
        { id: 'yitong-chen', name: { zh: '谌奕同', en: 'Yitong Chen' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'jiaying-he', name: { zh: '何佳莹', en: 'Jiaying He' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'sixian-li', name: { zh: '李思贤', en: 'Sixian Li' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'pengfei-wang', name: { zh: '王鹏飞', en: 'Pengfei Wang' }, photo: 'assets/img/default-avatar.svg' },
        { id: 'jinhao-wu', name: { zh: '吴锦皓', en: 'Jinhao Wu' }, photo: 'assets/img/吴锦皓.png' },
        { id: 'qianyi-wu', name: { zh: '吴乾奕', en: 'Qianyi Wu' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'haocheng-xu', name: { zh: '徐颢诚', en: 'Haocheng Xu' }, photo: 'assets/img/default-avatar.svg' },
        { id: 'chenchen-yang', name: { zh: '杨晨晨', en: 'Chenchen Yang' }, photo: 'assets/img/杨晨晨.jpg', homepage: 'https://cr-fish.github.io/' },
        { id: 'yuqian-yao', name: { zh: '姚寓骞', en: 'Yuqian Yao' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'yucheng-yuan', name: { zh: '袁宇成', en: 'Yucheng Yuan' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'zhiyu-zhang', name: { zh: '章之禹', en: 'Zhiyu Zhang' }, photo: 'assets/img/default-avatar.svg' },
        { id: 'guancheng-zhou', name: { zh: '周冠程', en: 'Guancheng Zhou' }, photo: 'assets/img/周冠程.jpg', homepage: 'https://guanchengzhou.github.io/' },
        { id: 'keyan-zhou', name: { zh: '周柯言', en: 'Keyan Zhou' }, photo: 'assets/img/default-avatar.svg' },
        { id: 'ying-zhu', name: { zh: '朱影', en: 'Ying Zhu' }, photo: 'assets/img/default-avatar.svg' }
    ],

    // 硕士研究生
    masterStudents: [
        { id: 'qingpeng-cao', name: { zh: '曹庆棚', en: 'Qingpeng Cao' }, photo: 'assets/img/default-avatar.svg' },
        { id: 'zhengwei-cao', name: { zh: '曹正伟', en: 'Zhengwei Cao' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'yaodong-chen', name: { zh: '陈耀东', en: 'Yaodong Chen' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'jinpeng-gao', name: { zh: '高金鹏', en: 'Jinpeng Gao' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'yu-han', name: { zh: '韩雨', en: 'Yu Han' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'ziyi-lei', name: { zh: '雷梓一', en: 'Ziyi Lei' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'zhehan-li', name: { zh: '李哲涵', en: 'Zhehan Li' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'ziyuan-liu', name: { zh: '刘子源', en: 'Ziyuan Liu' }, photo: 'assets/img/default-avatar.svg' },
        { id: 'xingyu-lu', name: { zh: '陆星宇', en: 'Xingyu Lu' }, photo: 'assets/img/陆星宇.jpg' },
        { id: 'xiaorui-luan', name: { zh: '栾效睿', en: 'Xiaorui Luan' }, photo: 'assets/img/default-avatar.svg' },
        { id: 'runyu-peng', name: { zh: '彭润宇', en: 'Runyu Peng' }, photo: 'assets/img/彭润宇.jpg' },
        { id: 'zhangfeng-qian', name: { zh: '钱张枫', en: 'Zhangfeng Qian' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'weixin-zhang', name: { zh: '张玮昕', en: 'Weixin Zhang' }, photo: 'assets/img/default-avatar.svg' },
        ...
        { id: 'fan-zhu', name: { zh: '朱凡', en: 'Fan Zhu' }, photo: 'assets/img/default-avatar.svg' },
...
const alumniData = {
    ...
    masters: [
        ...
        { name: { zh: '蒋昊', en: 'Hao Jiang' }, destination: { zh: '国企', en: 'State-Owned Enterprise' }, homepage: null },
        ...
        { name: { zh: '李鹏', en: 'Peng Li' }, destination: { zh: '上海创智学院', en: 'Shanghai Innovation Institution' }, homepage: null },
        ...
        { name: { zh: '王少敬', en: 'Shaojing Wang' }, destination: { zh: '国企', en: 'State-Owned Enterprise' }, homepage: null },
