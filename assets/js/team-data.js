...
const teamData = {
    ...
    coreMembers: [
        ...
        },
        {
            ...
            photo: 'assets/img/吕凯.jpg',
            homepage: 'https://kailv69.github.io/'
        }
    ],
    ...
    phdStudents: [
        ...
        { id: 'sixian-li', name: { zh: '李思贤', en: 'Sixian Li' }, photo: 'assets/img/李思贤.jpg', year: '2025' },
        ...
        { id: 'jiajun-chen', name: { zh: '陈嘉骏', en: 'Jiajun Chen' }, photo: 'assets/img/陈嘉骏.jpg', year: '2026' },
        { id: 'kuangwei-chen', name: { zh: '陈匡巍', en: 'Kuangwei Chen' }, photo: 'assets/img/陈匡巍.jpg', year: '2026' },
        { id: 'yanxin-chen', name: { zh: '陈衍鑫', en: 'Yanxin Chen' }, photo: 'assets/img/陈衍鑫.jpg', year: '2026' },
        { id: 'yitong-chen', name: { zh: '谌奕同', en: 'Yitong Chen' }, photo: 'assets/img/谌奕同.jpg', year: '2026' },
        { id: 'zihao-dai', name: { zh: '戴子皓', en: 'Zihao Dai' }, photo: 'assets/img/戴子皓.jpg', year: '2026' },
        { id: 'tianshi-gong', name: { zh: '龚天时', en: 'Tianshi Gong' }, photo: 'assets/img/龚天时.jpg', year: '2026' },
        { id: 'jiaying-he', name: { zh: '何佳莹', en: 'Jiaying He' }, photo: 'assets/img/何佳莹.jpg', year: '2026' },
        ...
        { id: 'pengfei-wang', name: { zh: '王鹏飞', en: 'Pengfei Wang' }, photo: 'assets/img/王鹏飞.jpg', year: '2026' },
        ...
        { id: 'qianyi-wu', name: { zh: '吴乾奕', en: 'Qianyi Wu' }, photo: 'assets/img/吴乾奕.jpg', year: '2026' },
        { id: 'ruixi-wu', name: { zh: '吴睿曦', en: 'Ruixi Wu' }, photo: 'assets/img/吴睿曦.jpeg', year: '2026' },
        { id: 'haocheng-xu', name: { zh: '徐颢诚', en: 'Haocheng Xu' }, photo: 'assets/img/徐颢诚.jpg', year: '2026' },
        { id: 'yuqian-yao', name: { zh: '姚寓骞', en: 'Yuqian Yao' }, photo: 'assets/img/姚寓骞.jpg', year: '2026' },
        ...
        { id: 'yucheng-yuan', name: { zh: '袁宇成', en: 'Yucheng Yuan' }, photo: 'assets/img/袁宇成.jpg', year: '2026' },
        { id: 'huazheng-zeng', name: { zh: '曾华正', en: 'Huazheng Zeng' }, photo: 'assets/img/曾华正.jpg', homepage: 'https://huazzeng.github.io/', year: '2026' },
        { id: 'zhiyu-zhang', name: { zh: '章之禹', en: 'Zhiyu Zhang' }, photo: 'assets/img/章之禹.jpg', year: '2026' },
        { id: 'keyan-zhou', name: { zh: '周柯言', en: 'Keyan Zhou' }, photo: 'assets/img/周柯言.jpg', year: '2026' },
        { id: 'ying-zhu', name: { zh: '朱影', en: 'Ying Zhu' }, photo: 'assets/img/朱影.jpg', year: '2026' },
    ...
    masterStudents: [
        ...
        { id: 'qingpeng-cao', name: { zh: '曹庆棚', en: 'Qingpeng Cao' }, photo: 'assets/img/曹庆棚.jpg', year: '2026' },
        { id: 'zhengwei-cao', name: { zh: '曹正伟', en: 'Zhengwei Cao' }, photo: 'assets/img/曹正伟.jpg', year: '2026' },
        { id: 'yaodong-chen', name: { zh: '陈耀东', en: 'Yaodong Chen' }, photo: 'assets/img/陈耀东.jpg', year: '2026' },
        { id: 'bowen-chen', name: { zh: '陈博闻', en: 'Bowen Chen' }, photo: 'assets/img/陈博闻.jpg', homepage: 'https://stivine.github.io/about', year: '2026' },
        { id: 'jinpeng-gao', name: { zh: '高金鹏', en: 'Jinpeng Gao' }, photo: 'assets/img/高金鹏.jpg', year: '2026' },
        { id: 'ziyi-lei', name: { zh: '雷梓一', en: 'Ziyi Lei' }, photo: 'assets/img/雷梓一.jpg', year: '2026' },
        { id: 'zhehan-li', name: { zh: '李哲涵', en: 'Zhehan Li' }, photo: 'assets/img/李哲涵.jpg', year: '2026' },
        { id: 'ziyuan-liu', name: { zh: '刘子源', en: 'Ziyuan Liu' }, photo: 'assets/img/刘子源.jpg', year: '2026' },
        { id: 'xiaorui-luan', name: { zh: '栾效睿', en: 'Xiaorui Luan' }, photo: 'assets/img/栾效睿.jpg', year: '2026' },
        { id: 'zhangfeng-qian', name: { zh: '钱张枫', en: 'Zhangfeng Qian' }, photo: 'assets/img/钱张枫.jpg', year: '2026' },
        ...
        { id: 'weixin-zhang', name: { zh: '张玮昕', en: 'Weixin Zhang' }, photo: 'assets/img/张玮昕.jpg', year: '2026' },
        { id: 'fan-zhu', name: { zh: '朱凡', en: 'Fan Zhu' }, photo: 'assets/img/朱凡.jpg', year: '2026' }
    ],

    // 非全日制
    partTimeStudents: [
        { id: 'tong-zhao', name: { zh: '赵桐', en: 'Tong Zhao' }, photo: 'assets/img/赵桐.jpg', year: '2024' },
        { id: 'zhongling-cai', name: { zh: '蔡忠岭', en: 'Zhongling Cai' }, photo: 'assets/img/蔡忠岭.jpg', year: '2025' },
        { id: 'ruiwen-hang', name: { zh: '杭瑞文', en: 'Ruiwen Hang' }, photo: 'assets/img/杭瑞文.jpg', year: '2025' }
    ],

    // 本科生
    undergraduates: [
        { id: 'mishuo-han', name: { zh: '韩米硕', en: 'Mishuo Han' }, photo: 'assets/img/韩米硕.jpg', year: '2023' },
        { id: 'xinzhe-he', name: { zh: '何欣喆', en: 'Xinzhe He' }, photo: 'assets/img/default-avatar.svg', year: '2023' },
        { id: 'zhan-huang', name: { zh: '黄湛', en: 'Huangzhan' }, photo: 'assets/img/黄湛.jpg', year: '2023' },
        { id: 'haochen-ma', name: { zh: '马颢宸', en: 'Haochen Ma' }, photo: 'assets/img/马颢宸.jpg', year: '2023' },
        { id: 'yurong-mou', name: { zh: '牟昱榕', en: 'Yurong Mou' }, photo: 'assets/img/牟昱榕.jpg', year: '2023' },
        { id: 'chenghao-wang', name: { zh: '王宬皓', en: 'Wang Chenghao' }, photo: 'assets/img/王宬皓.jpg', homepage: 'https://henrywch.github.io/', year: '2023' },
        { id: 'yanbo-wen', name: { zh: '温彦博', en: 'Yanbo Wen' }, photo: 'assets/img/温彦博.jpg', year: '2023' },
        { id: 'zhipeng-xu', name: { zh: '许志鹏', en: 'Zhipeng Xu' }, photo: 'assets/img/许志鹏.jpg', year: '2023' },
        { id: 'yikang-zhou', name: { zh: '周毅康', en: 'Yikang Zhou' }, photo: 'assets/img/周毅康.jpg', homepage: 'https://kevinconqueror.github.io/', year: '2023' },
        { id: 'chengyang-zhu', name: { zh: '朱程炀', en: 'Chengyang Zhu' }, photo: 'assets/img/朱程炀.png', homepage: 'https://github.com/Zecyel', year: '2023' },
        { id: 'mingshu-chen', name: { zh: '陈明树', en: 'Mingshu Chen' }, photo: 'assets/img/陈明树.jpg', year: '2024' },
        { id: 'zhihang-chen', name: { zh: '陈治航', en: 'Zhihang Chen' }, photo: 'assets/img/陈治航.jpg', year: '2024' },
        { id: 'bojun-cui', name: { zh: '崔博钧', en: 'Bojun Cui' }, photo: 'assets/img/崔博钧.jpg', year: '2024' },
        { id: 'tingshuo-fan', name: { zh: '范庭朔', en: 'Tingshuo Fan' }, photo: 'assets/img/范庭朔.png', homepage: 'https://survivor613.github.io/', year: '2024' },
        { id: 'shanqing-gao', name: { zh: '高山青', en: 'Gao Shanqing' }, photo: 'assets/img/高山青.jpg', homepage: 'https://github.com/Berdyanskov', year: '2024' },
        { id: 'chenxin-li', name: { zh: '李陈歆', en: 'Chenxin Li' }, photo: 'assets/img/李陈歆.jpg', year: '2024' },
        { id: 'yichang-liu', name: { zh: '刘一畅', en: 'Yichang Liu' }, photo: 'assets/img/刘一畅.jpg', year: '2024' },
        { id: 'shenling-qiu', name: { zh: '邱深凌', en: 'Shenling Qiu' }, photo: 'assets/img/邱深凌.jpg', year: '2024' },
        { id: 'yize-shen', name: { zh: '申益泽', en: 'Yize Shen' }, photo: 'assets/img/申益泽.jpg', year: '2024' },
        { id: 'hengmian-shi', name: { zh: '史恒勉', en: 'Hengmian Shi' }, photo: 'assets/img/史恒勉.jpg', year: '2024' },
        { id: 'yaowen-shi', name: { zh: '施耀文', en: 'Yaowen Shi' }, photo: 'assets/img/施耀文.jpg', year: '2024' },
        { id: 'chongwen-sun', name: { zh: '孙崇文', en: 'Milsonson' }, photo: 'assets/img/孙崇文.jpg', homepage: 'https://github.com/milsonson', year: '2024' },
        { id: 'zile-wang', name: { zh: '王子乐', en: 'Zile Wang' }, photo: 'assets/img/王子乐.jpg', year: '2024' },
        { id: 'zhide-xie', name: { zh: '谢志得', en: 'Zhide Xie' }, photo: 'assets/img/谢志得.jpg', year: '2024' },
        { id: 'yuhao-xu', name: { zh: '徐宇昊', en: 'Yuhao Xu' }, photo: 'assets/img/徐宇昊.jpg', year: '2024' },
        { id: 'wenkuo-yu', name: { zh: '于文阔', en: 'Wenkuo Yu' }, photo: 'assets/img/于文阔.jpg', year: '2024' },
        { id: 'chufan-yu', name: { zh: '俞楚凡', en: 'Chufan Yu' }, photo: 'assets/img/俞楚凡.jpg', year: '2024' },
        { id: 'chenxi-zhang', name: { zh: '张宸熙', en: 'Chenxi Zhang' }, photo: 'assets/img/张宸熙.jpg', year: '2024' },
        { id: 'jinghang-zhang', name: { zh: '张境航', en: 'Jinghang Zhang' }, photo: 'assets/img/张境航.jpg', year: '2024' },
        { id: 'wenzhi-zhang', name: { zh: '张文治', en: 'Wenzhi Zhang' }, photo: 'assets/img/张文治.jpg', year: '2024' },
        { id: 'hongji-chen', name: { zh: '陈鸿基', en: 'Hongji Chen' }, photo: 'assets/img/陈鸿基.jpg', homepage: 'https://realzillionx.github.io/', year: '2025' },
        { id: 'xinjia-he', name: { zh: '贺心嘉', en: 'XinJia He' }, photo: 'assets/img/贺心嘉.jpg', year: '2025' },
        { id: 'dechen-kong', name: { zh: '孔德宸', en: 'Dechen Kong' }, photo: 'assets/img/default-avatar.svg', year: '2025' },
        { id: 'yanbo-shao', name: { zh: '邵彦博', en: 'Yanbo Shao' }, photo: 'assets/img/default-avatar.svg', year: '2025' },
        { id: 'zongze-wu', name: { zh: '吴宗泽', en: 'Zongze Wu' }, photo: 'assets/img/吴宗泽.jpg', year: '2025' },
        { id: 'shenghao-zhang', name: { zh: '张圣皓', en: 'Shenghao Zhang' }, photo: 'assets/img/张圣皓.jpg', year: '2025' },
        { id: 'shiting-zhang', name: { zh: '张世庭', en: 'Shiting Zhang' }, photo: 'assets/img/default-avatar.svg', year: '2025' },
        { id: 'fan-yu', name: { zh: '俞凡', en: 'Fan Yu' }, photo: 'assets/img/default-avatar.svg', year: '2026' }
    ],

    // 访问学生（飞书组织架构中的“学术合作”，已在其他类别展示的成员不重复列出）
    visitingStudents: [
        { id: 'zuhua-jiang', name: { zh: '姜祖华', en: 'Zuhua Jiang' }, photo: 'assets/img/姜祖华.jpg' },
        { id: 'yanlin-li', name: { zh: '李彦霖', en: 'Yanlin Li' }, photo: 'assets/img/李彦霖.jpg' },
        { id: 'chuanyuan-tan', name: { zh: '谈川源', en: 'Chuanyuan Tan' }, photo: 'assets/img/谈川源.jpg' },
        { id: 'lei-xiao', name: { zh: '肖磊', en: 'Lei Xiao' }, photo: 'assets/img/default-avatar.svg' },
        { id: 'zhuo-yang', name: { zh: '杨卓', en: 'Zhuo Yang' }, photo: 'assets/img/杨卓.jpg' },
        { id: 'jiatong-zheng', name: { zh: '郑佳桐', en: 'Jiatong Zheng' }, photo: 'assets/img/郑佳桐.jpg' }
    ],
};
...
const alumniData = {
    ...
    phd: [
        ...
        { name: { zh: '邵云帆', en: 'Yunfan Shao' }, destination: { zh: '百度 ⬅️ 日行迹', en: 'Baidu ⬅️ Analemma' }, homepage: 'https://scholar.google.com/citations?user=pw5QEtoAAAAJ&hl=zh-CN', year: '2019' },
        { name: { zh: '孙天祥', en: 'Tianxiang Sun' }, destination: { zh: '百度（基础模型研发部负责人） ⬅️ 日行迹 CEO、上海创智学院 助理教授', en: 'Baidu (Head of Foundation Model R&D) ⬅️ CEO of Analemma, Assistant Professor at SII' }, homepage: 'https://txsun1997.github.io/', year: '2019' },
        { name: { zh: '颜航', en: 'Hang Yan' }, destination: { zh: '奇绩智峰 ⬅️ 上海人工智能实验室', en: 'Qiji Zhifeng ⬅️ Shanghai AI Laboratory' }, homepage: 'https://dl.acm.org/profile/99659996992', year: '2019' },
        ...
        { name: { zh: '刘向阳', en: 'Xiangyang Liu' }, destination: { zh: '百度 ⬅️ 日行迹', en: 'Baidu ⬅️ Analemma' }, homepage: 'https://scholar.google.com/citations?user=U8QD9mwAAAAJ&hl=en', year: '2020' },
        ...
        { name: { zh: '吕凯', en: 'Kai Lv' }, destination: { zh: '上海创智学院 研究助理教授', en: 'Research Assistant Professor, SII' }, homepage: 'https://kailv69.github.io/', year: '2021' },
    ...
    masters: [
        ...
        { name: { zh: '陈怡然', en: 'Yiran Chen' }, destination: { zh: '百度 ⬅️ 日行迹 ⬅️ 字节', en: 'Baidu ⬅️ Analemma ⬅️ ByteDance' }, homepage: null, year: '2019' },
        ...
        { name: { zh: '林天扬', en: 'Tianyang Lin' }, destination: { zh: '上海人工智能实验室 ⬅️ 阿里', en: 'Shanghai AI Laboratory ⬅️ Alibaba' }, homepage: null, year: '2020' },
        ...
        { name: { zh: '汤琼', en: 'Qiong Tang' }, destination: { zh: '百度 ⬅️ 日行迹', en: 'Baidu ⬅️ Analemma' }, homepage: null, year: '2022' },
        ...
        { name: { zh: '涂倩', en: 'Qian Tu' }, destination: { zh: '小米 MiMo', en: 'MiMo, Xiaomi' }, homepage: null, year: '2023' },
